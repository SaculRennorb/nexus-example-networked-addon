...
#include <windows.h>
#include "networking.h" // TODO @cleanup will likely want to merge the headers
...
typedef struct AddonAPI
{
	...
	PacketPrepareAndBroadcast* PrepareAndBroadcastPacket;
	PacketHandler*        HandleIncomingPacket;
} AddonAPI;
